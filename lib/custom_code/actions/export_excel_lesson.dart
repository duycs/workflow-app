...
Future exportExcelLesson(dynamic item) async {
  ...
  try {
    ...
    for (var item in dataList) {
      ...
      if (item["staff_lessions"] != null && item["staff_lessions"].isNotEmpty) {
        for (var lesson in item["staff_lessions"]) {
          String lessonName = lesson["lession_id"] != null &&
                  lesson["lession_id"]["name"] != null
              ? lesson["lession_id"]["name"]
              : '';
          String programName = lesson["program_id"] != null &&
                  lesson["program_id"]["name"] != null
