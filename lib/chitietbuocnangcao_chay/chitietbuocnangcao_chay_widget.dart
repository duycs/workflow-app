...
class ChitietbuocnangcaoChayWidget extends StatefulWidget {
  const ChitietbuocnangcaoChayWidget({super.key});

  @override
  State<ChitietbuocnangcaoChayWidget> createState() =>
      _ChitietbuocnangcaoChayWidgetState();
}

class _ChitietbuocnangcaoChayWidgetState
    extends State<ChitietbuocnangcaoChayWidget> with TickerProviderStateMixin {
  late ChitietbuocnangcaoChayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChitietbuocnangcaoChayModel());
