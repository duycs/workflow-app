...
class ChiTietTienDoCongViecWidget extends StatefulWidget {
  const ChiTietTienDoCongViecWidget({super.key});

  @override
  State<ChiTietTienDoCongViecWidget> createState() =>
      _ChiTietTienDoCongViecWidgetState();
}

class _ChiTietTienDoCongViecWidgetState
    extends State<ChiTietTienDoCongViecWidget> with TickerProviderStateMixin {
  late ChiTietTienDoCongViecModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChiTietTienDoCongViecModel());
