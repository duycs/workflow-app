...
class FileIDDataTypeStruct extends BaseStruct {
  ...
  static FileIDDataTypeStruct fromMap(Map<String, dynamic> data) =>
      FileIDDataTypeStruct(
  ...
  static FileIDDataTypeStruct? maybeFromMap(dynamic data) => data is Map
      ? FileIDDataTypeStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static FileIDDataTypeStruct fromSerializableMap(Map<String, dynamic> data) =>
      FileIDDataTypeStruct(
        id: deserializeParam(
          data['id'],
          ParamType.String,
  ...
  @override
  String toString() => 'FileIDDataTypeStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is FileIDDataTypeStruct &&
        id == other.id &&
        type == other.type &&
...
FileIDDataTypeStruct createFileIDDataTypeStruct({
  String? id,
  String? type,
  String? filenameDownload,
}) =>
