...
/// Start TimekeepingShiftConfigs Group Code

class TimekeepingShiftConfigsGroup {
  static String getBaseUrl({
    String? accessToken = '',
  }) =>
      'https://workflow-api.pexnic.com';
...
/// End TimekeepingShiftConfigs Group Code
...
class NewsfeedGroup {
  ...
  static CommentsNewFeedDeleteCall commentsNewFeedDeleteCall =
      CommentsNewFeedDeleteCall();
  static NewsfeedConfirmReadedCall newsfeedConfirmReadedCall =
      NewsfeedConfirmReadedCall();
  static CreateNewsFeedCall createNewsFeedCall = CreateNewsFeedCall();
  static EditNewsFeedCall editNewsFeedCall = EditNewsFeedCall();
}
...
class CommentsNewFeedDeleteCall {
  Future<ApiCallResponse> call({
    int? id,
    String? accessToken = '',
  }) async {
...
class NewsfeedConfirmReadedCall {
  Future<ApiCallResponse> call({
    String? newsId = '',
    String? staffId = '',
    String? accessToken = '',
    ...
    return FFApiInterceptor.makeApiCall(
      ApiCallOptions(
        ...
        params: {
          'filter': filter,
          'fields':
              "user_created.first_name, user_created.id, category_id, domain_id, private, copyright_organization_id,template,date_create,estimate_in_day,organization_id,id, status, name,date_created, description, duration_hours, lessions.lessions_id.id, lessions.lessions_id.name,lessions.lessions_id.status,tests.tests_id.id, tests.tests_id.name,tests.tests_id.description,tests.tests_id.duration_minutes,tests.tests_id.name,lessions.lessions_id.date_created,lessions.lessions_id.image_cover,tests.date_created,departments.departments_id.id,departments.departments_id.name, image_cover, template, price, author_id, copyright_program_id, copyright_organization_id, version, limit_invite, invite_count,tests.tests_id.good_score,tests.tests_id.user_created.id, departments.departments_id.branch_id.id,user_created.avatar,lessions.lessions_id.duration_hours,lessions.lessions_id,certificate_id.id,certificate_id.code,reacts",
          'offset': offset,
          'limit': limit,
          'meta': "total_count,filter_count",
          'sort': "-date_created",
...
/// Start GroupTimekeepings Group Code

class GroupTimekeepingsGroup {
  static String getBaseUrl({
    String? accessToken = '',
  }) =>
      'https://workflow-api.pexnic.com';
