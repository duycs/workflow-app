...
class _ProcedureUpdateWidgetState extends State<ProcedureUpdateWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      setState(() {});
      if (_model.dataUpdate!.departments.length > 0) {
        setState(() {});
      } else {
                ...
                onPressed: () async {
                  ...
                  _model.updateDataUpdateStruct(
                    (e) => e
                      ...
                      ..description = _model.textDescriptionTextController.text,
                  );
                  setState(() {});
                  ...
                  if (_model.tokenReloadProcedurUpdate!) {
                    ...
                    if (_model.dataUpdate?.name != null &&
                      ...
                      setState(() {});
                      _model.updateRequestUpdateStruct(
                        (e) => e..staffs = _model.dataUpdateStaffs.toList(),
                      );
                      setState(() {});
                      while (
                      ...
                      _model.updateRequestUpdateStruct(
                        (e) =>
                            e..departments = _model.updateDepartments.toList(),
                      );
                      setState(() {});
                      ...
                      while (_model.loop < _model.stepList.length) {
                        _model.addToStepsUpdate(WorkflowsStepCreateStruct(
                          status: _model.stepList[_model.loop].status != null &&
                                  _model.stepList[_model.loop].status != ''
                              ? _model.stepList[_model.loop].status
                              : '',
                          description: _model
                                          .stepList[_model.loop].description !=
                                      null &&
                          ...
                          actionType: _model.stepList[_model.loop].actionType !=
                              ...
                              : '',
                          staffsAlias: _model
                                          .stepList[_model.loop].staffsAlias !=
                                      null &&
                                  _model.stepList[_model.loop].staffsAlias != ''
                              ? _model.stepList[_model.loop].staffsAlias
                              : '',
                          timeOperate: _model
                                          .stepList[_model.loop].timeOperate !=
                                      null &&
                          ...
                          estimateInSecond: _model
                                  ...
                                  null
                              ? _model.stepList[_model.loop].estimateInSecond
                              : 0,
                          number: _model.stepList[_model.loop].number,
                        ));
                        setState(() {});
                        if (_model.stepList[_model.loop].id != null &&
                            _model.stepList[_model.loop].id != '') {
                        ...
                        if (((_model.stepList[_model.loop].staffs.isNotEmpty) !=
                                null) &&
                            (_model.stepList[_model.loop].staffs.length > 0)) {
                          while (_model.loop2 <
                        ...
                        if (_model.stepList[_model.loop].operations.length >
                            0) {
                          while (
                                                              ...
                                                              child:
                                                                ...
                                                                controller: _model
                                                                    ...
                                                                    FormFieldController<
                                                                        List<
                                                                            String>>(
                                                                  List.from(functions.cronToType(_model
                                                                          .dataUpdate!
                                                                          .cron) ??
                                                                      []),
                                                                ),
                                                                    ...
                                                                    return Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          wrapWithModel(
                                                                            model:
                                                                                _model.checkBoxToggleModels1.getModel(
                                                                    ...
                                                                    return Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          wrapWithModel(
                                                                            model:
                                                                                _model.checkBoxToggleModels2.getModel(
                                                                    ...
                                                                    return Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          wrapWithModel(
                                                                            model:
                                                                                _model.checkBoxToggleModels3.getModel(
                                                                    ...
                                                                    return Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          wrapWithModel(
                                                                            model:
                                                                                _model.checkBoxToggleModels4.getModel(
                                                                    ...
                                                                    return Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          wrapWithModel(
                                                                            model:
                                                                                _model.checkBoxToggleModels5.getModel(
                                    ...
                                    builder: (context) {
                                      ...
                                      return ReorderableListView.builder(
                                        ...
                                        itemBuilder: (context, listViewIndex) {
                                          ...
                                          return Container(
                                            key: ValueKey("ListView_4plixxgx" +
                                                '_' +
                                                                            ...
                                                                            return Dialog(
                                                                              ...
                                                                              child: GestureDetector(
                                                                                ...
                                                                                child: ProcedureStepMenuWidget(
                                                                                  item: listViewItem,
                                                                                  idItem: listViewItem.id != null && listViewItem.id != '' ? listViewItem.id : 'null',
                                                                                  ...
                                                                                  callBackDelete: () async {
                                                                                    if (listViewItem.id != null && listViewItem.id != '') {
