...
class ProcedureStepUpdateWidget extends StatefulWidget {
  const ProcedureStepUpdateWidget({
    super.key,
    required this.data,
    this.callBack,
    required this.calBackUnBottom,
  });

  final WorkflowsStepCreateStruct? data;
  final Future Function(StepsStruct? addItem)? callBack;
  final Future Function()? calBackUnBottom;

  @override
  State<ProcedureStepUpdateWidget> createState() =>
      _ProcedureStepUpdateWidgetState();
}

class _ProcedureStepUpdateWidgetState extends State<ProcedureStepUpdateWidget> {
  late ProcedureStepUpdateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProcedureStepUpdateModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      while (_model.loop! < widget!.data!.departments.length) {
        ...
        _model.updateStafStepDepartmentsAtIndex(
          _model.loop!,
          (e) => e..checkStaff = _model.checkStaffList.toList(),
        );
        setState(() {});
    ...
    _model.textNameTextController ??= TextEditingController(
        text: widget!.data?.name != null && widget!.data?.name != ''
            ? widget!.data?.name
            : ' ');
                      ...
                      children: [
                            ...
                            children: [
                              FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  ...
                                  await widget.calBackUnBottom?.call();
                                },
                              ),
                            ],
                          ),
                          ...
                          onChanged: (_) => EasyDebounce.debounce(
                            ...
                            () async {
                              _model.updateStepsEditStruct(
                                (e) => e
                                  ..description =
                                      _model.textDscriptionTextController.text,
                              );
                              setState(() {});
                            },
                          ),
                          ...
                          child: InkWell(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  _model.stepsEdit?.timeOperate != null &&
                                          _model.stepsEdit?.timeOperate != ''
                                      ? 'Bắt đầu : ${_model.stepsEdit?.timeOperate}'
                                      : ' Bắt đầu : ',
                        ...
                        if ('1' == '2')
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                'Thời gian thực hiện: ${_model.stepsEdit?.estimateInSecond != null ? formatNumber(
                        ...
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 10.0, 0.0, 0.0),
                          child: Text(
                            '#Chọn bộ phận hoặc nhân viên thực hiện nhiêm vụ',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  fontFamily: 'Nunito Sans',
                        ...
                        Builder(
                          builder: (context) {
                            ...
                            return ListView.separated(
                              ...
                              separatorBuilder: (_, __) =>
                                  SizedBox(height: 4.0),
                              itemBuilder: (context, departmentsListViewIndex) {
                        ...
                        Builder(
                          builder: (context) {
                            final staffsListView = _model.staffsStepNv.toList();
                    ...
                    Expanded(
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          _model.staffListId = [];
                          _model.heckStaffList = [];
                          _model.staffsStep = [];
                          _model.departmentsStepList = [];
                          ...
                          if (_model.stepsEdit!.operations.length > 0) {
                            if ((_model.staffsStepNv.length > 0) ||
                                (_model.stafStepDepartments.length > 0)) {
                              setState(() {});
                            } else {
                            ...
                            while (_model.loop! <
                              ...
                              _model.addToDepartmentsList(DepartmentsStruct(
                              ...
                              setState(() {});
                              _model.addToDepartmentsStepList(
                              ...
                              while (_model.loop2 <
                                  _model.stafStepDepartments[_model.loop!]
                                      .checkStaff.length) {
                                _model.addToStaffsStep(StaffsStepStruct(
                                  staffsId: StaffIdStruct(
                                    id: _model.stafStepDepartments[_model.loop!]
                                        .checkStaff[_model.loop2].staffsId.id,
                                    staffName: _model
                                ...
                                _model.addToHeckStaffList(StaffsStepStruct(
                                  staffsId: StaffIdStruct(
                                    id: _model.stafStepDepartments[_model.loop!]
                                        .checkStaff[_model.loop2].staffsId.id,
                                    userId: UserIdStruct(
                              ...
                              _model.loop2 = 0;
                              setState(() {});
                              _model.updateDepartmentsStepListAtIndex(
                                _model.loop!,
                                (e) => e
                                  ..checkStaff = _model.heckStaffList.toList(),
                              );
                              setState(() {});
                              _model.loop = _model.loop! + 1;
                              setState(() {});
                            ...
                            _model.loop2 = 0;
                            setState(() {});
                            while (_model.loop! < _model.staffsStepNv.length) {
                              _model.addToHeckStaffList(StaffsStepStruct(
                                staffsId: StaffIdStruct(
                                  id: _model
                                      .staffsStepNv[_model.loop!].staffsId.id,
                                  userId: UserIdStruct(
                                    firstName: _model.staffsStepNv[_model.loop!]
                            ...
                            _model.updateStepsEditStruct(
                              (e) => e
                                ..departments =
                                    _model.departmentsStepList.toList()
                                ..staffs = _model.heckStaffList.toList(),
                            );
                            setState(() {});
                            while (_model.loop! <
                              ...
                              while (_model.loop2 <
                                ...
                                if ((_model.stepsEdit?.staffs?[_model.loop!])
                                    ...
                                    (_model.stepsEdit?.staffs?[_model.loop2])
                                        ?.staffsId
                                        ?.id) {
                                  _model.addToCheckStaff(CheckUpdateStepStruct(
                                    firstName: (_model
                            ...
                            if (_model.checkStaff.length > 0) {
                              ...
                              _model.updateStepsEditStruct(
                                (e) => e
                                  ..staffsAlias = functions
                                      .jsontoString(_model.staffAlias?.toMap()),
                              );
                              setState(() {});
