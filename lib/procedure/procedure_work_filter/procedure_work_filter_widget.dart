...
class ProcedureWorkFilterWidget extends StatefulWidget {
  const ProcedureWorkFilterWidget({
    super.key,
    this.name,
    this.callback,
  ...
  final Future Function(
          String? name, String? dateStart, String? dateEnd, String? staffid)?
      callback;
  ...
  @override
  State<ProcedureWorkFilterWidget> createState() =>
      _ProcedureWorkFilterWidgetState();
}

class _ProcedureWorkFilterWidgetState extends State<ProcedureWorkFilterWidget> {
  late ProcedureWorkFilterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProcedureWorkFilterModel());
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: wrapWithModel(
                            ...
                            updateOnChange: true,
                            child: StaffsListDropdownWidget(
                              value: _model.staff != null && _model.staff != ''
                                  ? _model.staff
                                  : '',
                              type: true,
                              callBack: (item) async {
