...
class _BranchDetailWidgetState extends State<BranchDetailWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BranchDetailModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiResultGetList =
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: Stack(
          children: [
            if ((_model.departmentList.isNotEmpty) == true)
              Column(
            ...
            if ((_model.departmentList.isNotEmpty) == false)
              SizedBox(
                width: double.infinity,
