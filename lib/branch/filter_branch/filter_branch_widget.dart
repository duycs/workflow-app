...
class FilterBranchWidget extends StatefulWidget {
  ...
  @override
  State<FilterBranchWidget> createState() => _FilterBranchWidgetState();
}

class _FilterBranchWidgetState extends State<FilterBranchWidget> {
  late FilterBranchModel _model;
