...
import 'report_task_detail_copy_model.dart';
export 'report_task_detail_copy_model.dart';

class ReportTaskDetailCopyWidget extends StatefulWidget {
  const ReportTaskDetailCopyWidget({
    super.key,
  ...
  @override
  State<ReportTaskDetailCopyWidget> createState() =>
      _ReportTaskDetailCopyWidgetState();
}

class _ReportTaskDetailCopyWidgetState extends State<ReportTaskDetailCopyWidget>
    with TickerProviderStateMixin {
  late ReportTaskDetailCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReportTaskDetailCopyModel());
