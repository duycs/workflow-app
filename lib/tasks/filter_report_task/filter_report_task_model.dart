...
import 'filter_report_task_widget.dart' show FilterReportTaskWidget;
import 'package:flutter/material.dart';

class FilterReportTaskModel extends FlutterFlowModel<FilterReportTaskWidget> {
  ...
  // Stores action output result for [Action Block - tokenReload] action in FilterReportTask widget.
  bool? getListBranchToken3;
  // Stores action output result for [Backend Call - API (BranchList)] action in FilterReportTask widget.
  ApiCallResponse? apiResultGetListBranch3;
  // Stores action output result for [Action Block - tokenReload] action in FilterReportTask widget.
  bool? listDeparment5Token;
  // Stores action output result for [Backend Call - API (GetDepartmentList)] action in FilterReportTask widget.
