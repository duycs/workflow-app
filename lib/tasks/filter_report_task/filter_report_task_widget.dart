...
import 'filter_report_task_model.dart';
export 'filter_report_task_model.dart';

class FilterReportTaskWidget extends StatefulWidget {
  const FilterReportTaskWidget({
    super.key,
    this.filterSearch,
    this.callback,
    this.status,
  ...
  @override
  State<FilterReportTaskWidget> createState() => _FilterReportTaskWidgetState();
}

class _FilterReportTaskWidgetState extends State<FilterReportTaskWidget> {
  late FilterReportTaskModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FilterReportTaskModel());
