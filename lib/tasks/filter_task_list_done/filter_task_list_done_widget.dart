...
class FilterTaskListDoneWidget extends StatefulWidget {
  const FilterTaskListDoneWidget({
    super.key,
    this.filterSearch,
  ...
  State<FilterTaskListDoneWidget> createState() =>
      _FilterTaskListDoneWidgetState();
}

class _FilterTaskListDoneWidgetState extends State<FilterTaskListDoneWidget> {
  late FilterTaskListDoneModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FilterTaskListDoneModel());
                            ...
                            if (_model.filterDoneToken!) {
                              _model.apiResultFilterDone =
                                ...
                                filter:
                                  ...
                                  FFAppState().staffLogin,
                                  r'''$.organization_id''',
                                ).toString()}\"}}},{\"_or\":[{\"status\":{\"_eq\":\"done\"}},{\"status\":{\"_eq\":\"approved\"}}]}${widget.filterSearch != null && widget.filterSearch != '' ? ',{\"name\":{\"_icontains\":\"${widget.filterSearch}\"}}' : ' '}${_model.dateStart != null && _model.dateStart != '' ? ',{\"date_created\":{\"_gte\":\"${_model.dateStart}\"}}' : ' '}${_model.dateEnd != null && _model.dateEnd != '' ? ',{\"date_created\":{\"_lte\":\"${_model.dateEnd}\"}}' : ' '}${_model.typeValue != null && _model.typeValue != '' ? ',{\"action_type\":{\"_eq\":\"${() {
