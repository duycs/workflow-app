...
import '/profile/contact_profile_c_p_n/contact_profile_c_p_n_widget.dart';
import 'dart:async';
import 'dart:ui';
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      TextSpan(
                                                                        text: (_model.organizationDetail?.hotline != null && _model.organizationDetail?.hotline != '') &&
                                                                                (_model.organizationDetail?.hotline != 'undefined') &&
                                                                                (_model.organizationDetail?.hotline != 'null')
                                                                  ...
                                                                  Text(
                                                                    _model.organizationDetail!.staffs.isNotEmpty
                                                                        ? '${valueOrDefault<String>(
                                                                            _model.organizationDetail?.staffs.length.toString(),
                                                                            '0',
                                                                          )} Nhân viên'
                                                                        : '0Nhân viên',
                                                                    style: FlutterFlowTheme.of(
                                                                  ...
                                                                  Expanded(
                                                                    child:
                                                                      ...
                                                                      children:
                                                                        ...
                                                                        if ((_model.organizationDetail?.staffs.where((e) => e.userId.role == '82073000-1ba2-43a4-a55c-459d17c23b68').toList().first.title != null && _model.organizationDetail?.staffs.where((e) => e.userId.role == '82073000-1ba2-43a4-a55c-459d17c23b68').toList().first.title != '') &&
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      final adminBranch = _model
                                                                              .organizationDetail
                                                                              ?.staffs
                                                                              .where((e) => e.userId.role == 'a8d33527-375b-4599-ac70-6a3fcad1de39')
                                                                              .toList()
                                                                              .toList() ??
                                                                          [];
                                                                      return ListView
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                child: Align(
                                                                                  ...
                                                                                  child: Padding(
                                                                                    padding: const EdgeInsetsDirectional.fromSTEB(10.0, 10.0, 10.0, 10.0),
                                                                                    child: Text(
                                                                                      'Chất lượng cao cấp hàng đầu bằng chính sự trân trọng, tình yêu và trách nhiệm cao của mình với cuộc sống con người và xã hội,Chất lượng cao cấp hàng đầu bằng chính sự trân trọng, tình yêu và trách nhiệm cao của mình với cuộc sống con người và xã hội,',
                                                                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                            fontFamily: 'Nunito Sans',
                                                                                            letterSpacing: 0.0,
                                                                                          ),
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Expanded(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children:
                                                                          [
                                                                        if (_model.organizationDetail!.files.length >=
                                                                            2)
                                                                          Padding(
                                                                            padding: const EdgeInsetsDirectional.fromSTEB(
                                                                                0.0,
