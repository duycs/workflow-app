                                                        ...
                                                        children: [
                                                          ...
                                                          Row(
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(
                                                                (_model.organizationDetail!.branchs.isNotEmpty) &&
                                                                        ((_model.organizationDetail?.branchs.where((e) => e.departments.where((e) => e.status == 'published').toList().isNotEmpty).toList() != null &&
                                                                                (_model.organizationDetail?.branchs.where((e) => e.departments.where((e) => e.status == 'published').toList().isNotEmpty).toList())!.isNotEmpty) ==
                                                                            true)
                                                                    ? '${((List<int> var1) {
