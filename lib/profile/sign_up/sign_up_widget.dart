    ...
    return Scaffold(
      ...
      body: Align(
        ...
        child: Container(
          ...
          alignment: const AlignmentDirectional(0.0, 0.0),
          child: Padding(
            padding: const EdgeInsetsDirectional.fromSTEB(24.0, 32.0, 24.0, 36.0),
                              ...
                              onPressed: () async {
                                ...
                                _model.apiResultCreateUser = await AuthenGroup
                                  ...
                                  requestDataJson: <String, dynamic>{
                                    ...
                                    'status': 'active',
                                    'organization':
                                        _model.organizationTextController.text,
                                    'avatar':
                                ...
                                if ((_model.apiResultCreateUser?.succeeded ??
                                    true)) {
                                  if (getJsonField(
                                        (_model.apiResultCreateUser?.jsonBody ??
                                            ''),
                                        r'''$.message''',
                                      ).toString() ==
