                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      _model.staffDetail != null
                                          ? _model.staffDetail!.userId.firstName
                                          : ' ',
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            if (_model.staffDetail != null)
                                              Text(
                                                _model.staffDetail!.staffTests.isNotEmpty
                                                    ? ((List<String> var1,
                                                            int var2) {
                                                        return ((var1
                                                                    .map(double
                                                  ...
                                                  child: Padding(
                                                    padding:
                                                        MediaQuery.viewInsetsOf(
                                                            context),
                                                    child: const AuthorSignUpWidget(),
                                                  ),
                                                );
                                              },
                                            ).then(
