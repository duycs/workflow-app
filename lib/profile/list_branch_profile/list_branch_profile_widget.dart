  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (_model.checkTokenListBranchProfile!) {
        while (FFAppState().scrollCheck == 'ListBranchProfile') {
          _model.tokenReloadListBranchProfileCheck =
              await action_blocks.tokenReload(context);
          if (_model.tokenReloadListBranchProfileCheck!) {
                    ...
                    child: PagedListView<ApiPagingParams, dynamic>.separated(
                      ...
                      builderDelegate: PagedChildBuilderDelegate<dynamic>(
                        ...
                        itemBuilder: (context, _, listItemIndex) {
                          final listItemItem = _model.listViewPagingController1!
