...
class _LoginWidgetState extends State<LoginWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance
      ...
      _model.checkEmailWf =
          await actions.checkLoginSharePreferences(
        'wf_email',
        'wf_token',
      );
      if (_model.checkEmailWf == true) {
        ...
        if ((_model.apiResultRefreshTokenLogin?.succeeded ??
            true)) {
          FFAppState().update(() {
            FFAppState().accessToken =
                LoginResourceDataStruct.maybeFromMap((_model
                            .apiResultRefreshTokenLogin
                            ?.jsonBody ??
                        ''))!
                    .data
                    .accessToken;
            ...
            FFAppState().expires =
                LoginResourceDataStruct.maybeFromMap((_model
                    ...
                    .expires;
            FFAppState()
                .dataTimeStartToken = (DateTime.now()
          ...
          if ((_model.apiResultGetStaffIdReWfLogin
                  ?.succeeded ??
              true)) {
            setState(() {
                                            ...
                                            Padding(
                                              padding:
                                                  const EdgeInsetsDirectional
                                                      ...
                                                      24.0),
                                              child: Text(
                                                'Chúc ngày mới tốt lành. Chào mừng bạn quay trở lại với hệ thống quản lý Workflow',
                                                textAlign:
                                                    TextAlign
                                                        .start,
                                                style: FlutterFlowTheme.of(
