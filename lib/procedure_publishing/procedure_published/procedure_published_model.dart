...
import 'procedure_published_widget.dart' show ProcedurePublishedWidget;
...
class ProcedurePublishedModel
    extends FlutterFlowModel<ProcedurePublishedWidget> {
  ...
  // Stores action output result for [Backend Call - API (workflowsList)] action in ProcedurePublished widget.
