...
export 'procedure_published_list_copy2_model.dart';

class ProcedurePublishedListCopy2Widget extends StatefulWidget {
  const ProcedurePublishedListCopy2Widget({super.key});

  @override
  State<ProcedurePublishedListCopy2Widget> createState() =>
      _ProcedurePublishedListCopy2WidgetState();
}

class _ProcedurePublishedListCopy2WidgetState
    extends State<ProcedurePublishedListCopy2Widget> {
  late ProcedurePublishedListCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProcedurePublishedListCopy2Model());
