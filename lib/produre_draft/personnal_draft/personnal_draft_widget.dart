...
class PersonnalDraftWidget extends StatefulWidget {
  const PersonnalDraftWidget({super.key});

  @override
  State<PersonnalDraftWidget> createState() => _PersonnalDraftWidgetState();
}

class _PersonnalDraftWidgetState extends State<PersonnalDraftWidget> {
  late PersonnalDraftModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PersonnalDraftModel());
