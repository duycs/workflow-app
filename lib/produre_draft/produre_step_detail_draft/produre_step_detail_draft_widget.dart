...
class ProdureStepDetailDraftWidget extends StatefulWidget {
  const ProdureStepDetailDraftWidget({super.key});

  @override
  State<ProdureStepDetailDraftWidget> createState() =>
      _ProdureStepDetailDraftWidgetState();
}

class _ProdureStepDetailDraftWidgetState
    extends State<ProdureStepDetailDraftWidget> with TickerProviderStateMixin {
  late ProdureStepDetailDraftModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProdureStepDetailDraftModel());
                            ...
                            Padding(
                              ...
                              child: Theme(
                                ...
                                child: CheckboxListTile(
                                  ...
                                  subtitle: Text(
                                    'Kết quả của bước này là đầu vào của bước sau',
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                          fontFamily: 'Nunito Sans',
