...
class ChitietbuocWidget extends StatefulWidget {
  const ChitietbuocWidget({super.key});

  @override
  State<ChitietbuocWidget> createState() => _ChitietbuocWidgetState();
}

class _ChitietbuocWidgetState extends State<ChitietbuocWidget> {
  late ChitietbuocModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChitietbuocModel());
