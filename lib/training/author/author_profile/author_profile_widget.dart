        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                                                              ...
                                                              Text(
                                                                programListItem
                                                                    ...
                                                                    ? ((List<String>
                                                                            ...
                                                                            int
                                                                                numOfList) {
                                                                        return ((listRating.map(double.parse).reduce((a, b) => a + b)) /
                                                                                numOfList)
                                                                            .toStringAsFixed(2);
                                                                      }(
                                                                        programListItem
              ...
              if ((_model.checkClick == '1') && (_model.programs.isNotEmpty))
                Padding(
                    ...
                    child: Builder(
                      builder: (context) {
                        ...
                        return GridView.builder(
                          ...
                          itemCount: domainList.length,
                          itemBuilder: (context, domainListIndex) {
                            final domainListItem = domainList[domainListIndex];
                            return Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 0.0, 20.0),
                              child: InkWell(
