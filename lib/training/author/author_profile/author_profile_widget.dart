...
import '/training/author/rating_bar_program/rating_bar_program_widget.dart';
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children:
                                                                            ...
                                                                            Row(
                                                                              ...
                                                                              children: [
                                                                                if (programListItem.reacts.isNotEmpty)
                                                                                  RatingBarProgramWidget(
                                                                                    key: Key('Keytym_${programListIndex}_of_${programList.length}'),
                                                                                    rating: (List<String> listRating, int numOfList) {
