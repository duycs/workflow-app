...
import 'filter_study_program_user_model.dart';
export 'filter_study_program_user_model.dart';

class FilterStudyProgramUserWidget extends StatefulWidget {
  const FilterStudyProgramUserWidget({
    super.key,
    String? name,
    String? lessonName,
    String? dateStart,
  ...
  final Future Function(
          String? name, String? lessonName, String? dateStart, String? dateEnd)?
      callBack;

  @override
  State<FilterStudyProgramUserWidget> createState() =>
      _FilterStudyProgramUserWidgetState();
}

class _FilterStudyProgramUserWidgetState
    extends State<FilterStudyProgramUserWidget> {
  late FilterStudyProgramUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FilterStudyProgramUserModel());
