                        ...
                        child: SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            onChanged: (_) => EasyDebounce.debounce(
                              ...
                              () async {
                                _model.isLoad = false;
                                _model.listLessonRow = [];
                                _model.listLessonRow2 = [];
                                _model.listLessonRow3 = [];
                                setState(() {});
                                await _model.getListLessonRow(context);
                                setState(() {});
                                await _model.getListLessonRow2(context);
                                ...
                                child: SingleChildScrollView(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      if ((_model.listLessonRow.isNotEmpty) &&
                                          (_model.listLessonRow.length == 11))
                                        Padding(
                                          padding:
                                ...
                                child: SingleChildScrollView(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      if ((_model.listLessonRow2.isNotEmpty) &&
                                          (_model.listLessonRow2.length == 11))
                                        Padding(
                                          padding:
                                              const EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 0.0, 12.0, 0.0),
                              ...
                              child: SingleChildScrollView(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    if ((_model.listLessonRow3.isNotEmpty) &&
                                        (_model.listLessonRow3.length == 11))
                                      Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            0.0, 0.0, 12.0, 0.0),
                                        child: InkWell(
