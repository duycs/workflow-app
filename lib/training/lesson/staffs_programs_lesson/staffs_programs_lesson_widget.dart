...
class _StaffsProgramsLessonWidgetState
    extends State<StaffsProgramsLessonWidget> {
                        ...
                        children: [
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                _model
                                    .staffsLessionsListOne.first.lessionId.name,
                                  ...
                                  children: [
                                    if ((_model.status != 'draft') &&
                                      ...
                                      FlutterFlowVideoPlayer(
                                        path:
                                            '${FFAppConstants.ApiBaseUrl}/assets/${_model.staffsLessionsListOne.first.lessionId.video}?access_token=${FFAppState().accessToken}',
                                                                ...
                                                                if ((_model
                                                                    ...
                                                                    ((((String
                                                                              ...
                                                                              return type.split('.').last;
                                                                                ...
                                                                                .staffsLessionsListOne.first.lessionId.file.filenameDownload)) ==
                                                                            'doc') ||
                                                                        (((String
                                                                                type) {
                                                                              return type.split('.').last;
