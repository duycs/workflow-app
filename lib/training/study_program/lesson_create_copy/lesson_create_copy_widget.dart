...
import 'lesson_create_copy_model.dart';
export 'lesson_create_copy_model.dart';

class LessonCreateCopyWidget extends StatefulWidget {
  const LessonCreateCopyWidget({
    super.key,
    String? checkScroll,
    this.checkPage,
  ...
  @override
  State<LessonCreateCopyWidget> createState() => _LessonCreateCopyWidgetState();
}

class _LessonCreateCopyWidgetState extends State<LessonCreateCopyWidget> {
  late LessonCreateCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LessonCreateCopyModel());
              ...
              await showDialog(
                ...
                builder: (alertDialogContext) {
                  return AlertDialog(
                    ...
                    content: Text(_model.testIdValue!),
                    actions: [
                      TextButton(
