                              ...
                              wrapWithModel(
                                ...
                                child: TestsDropdownWidget(
                                  value: widget.dataDetail!.tests.isNotEmpty
                                      ? widget
                                          .dataDetail?.tests.first.testsId.id
                                      : ' ',
                  ...
                  onPressed: () async {
                    ...
                    if (_model.tokenStudyProgramEdit!) {
                      ...
                      if ((_model.estimateInDayTextController.text != '') &&
                          (_model.estimateInDayTextController.text != 'null') &&
                        ...
                        _model.apiResultSynchronizedStaffLesson1 =
                            await StudyProgramGroup.synchronizedStaffLessonCall
                                .call(
                          accessToken: FFAppState().accessToken,
                          programId: widget.dataDetail?.id,
                        );
                        ...
                        shouldSetState = true;
                        if ((_model
                                .apiResultSynchronizedStaffLesson1?.succeeded ??
                            true)) {
                          await widget.callBackList1?.call();
                        } else {
                          ScaffoldMessenger.of(context).showSnackBar(
