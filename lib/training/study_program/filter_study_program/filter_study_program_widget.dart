...
class FilterStudyProgramWidget extends StatefulWidget {
  const FilterStudyProgramWidget({
    super.key,
    required this.name,
  ...
  State<FilterStudyProgramWidget> createState() =>
      _FilterStudyProgramWidgetState();
}

class _FilterStudyProgramWidgetState extends State<FilterStudyProgramWidget> {
  late FilterStudyProgramModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FilterStudyProgramModel());
