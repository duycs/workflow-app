...
import 'infor_list_model.dart';
export 'infor_list_model.dart';

class InforListWidget extends StatefulWidget {
  const InforListWidget({super.key});

  @override
  State<InforListWidget> createState() => _InforListWidgetState();
}

class _InforListWidgetState extends State<InforListWidget> {
  late InforListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InforListModel());
  }
