...
import 'profile_publish2_model.dart';
export 'profile_publish2_model.dart';

class ProfilePublish2Widget extends StatefulWidget {
  const ProfilePublish2Widget({super.key});

  @override
  State<ProfilePublish2Widget> createState() => _ProfilePublish2WidgetState();
}

class _ProfilePublish2WidgetState extends State<ProfilePublish2Widget> {
  late ProfilePublish2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfilePublish2Model());
  }
