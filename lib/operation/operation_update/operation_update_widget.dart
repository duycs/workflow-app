...
class OperationUpdateWidget extends StatefulWidget {
  const OperationUpdateWidget({
    super.key,
    this.operationUpdate,
  });

  final OperationsStruct? operationUpdate;

  @override
  State<OperationUpdateWidget> createState() => _OperationUpdateWidgetState();
}

class _OperationUpdateWidgetState extends State<OperationUpdateWidget> {
  late OperationUpdateModel _model;
                            ...
                            FlutterFlowDropDown<String>(
                              controller: _model.dropDownValueController ??=
                                ...
                                _model.dropDownValue ??=
                                    widget.operationUpdate?.actionType,
                              ),
                              options: const [
                                'submit_text',
                                'image',
