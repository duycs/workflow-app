                          ...
                          children: [
                            Stack(
                              ...
                              children: [
                                                      ...
                                                      padding:
                                                          const EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  4.0),
                                                      child: Text(
                                                        'Nội dung: ${itemOperationItem.content}',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodyMedium
                                ...
                                if ((_model.operationList.isEmpty) &&
                                    (_model.isLoad == true))
                                  Padding(
                                  ...
                                  builder: (context) {
                                    ...
                                    return ListView.separated(
                                      ...
                                      separatorBuilder: (_, __) =>
                                          const SizedBox(height: 8.0),
                                      itemBuilder:
                                          (context, itemUserCreatedIndex) {
                                        final itemUserCreatedItem =
                                            itemUserCreated[
                                                itemUserCreatedIndex];
                                        return InkWell(
                                          splashColor: Colors.transparent,
                                          focusColor: Colors.transparent,
                                          hoverColor: Colors.transparent,
                                                    ...
                                                    padding:
                                                        const EdgeInsetsDirectional
                                                            .fromSTEB(0.0, 0.0,
                                                                0.0, 4.0),
                                                    child: Text(
                                                      'Nội dung: ${itemUserCreatedItem.content}',
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .bodyMedium
                                                          .override(
                                                    ...
                                                    padding:
                                                        const EdgeInsetsDirectional
                                                            .fromSTEB(0.0, 0.0,
                                                                0.0, 4.0),
                                                    child: Text(
                                                      'Nội dung: ${itemDefaultItem.content}',
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .bodyMedium
                                                          .override(
